...
YYB first scored 750 for 100 numbers by pushing the smallest half to A, then the smallest half of the rest, and so on till A is empty, and selection sorting them back to A. After this, she switched to a new strategy: bucket sort to B with 8 equal-sized buckets (although it sounds like the buckets are not arranged in descending order on B?), then push whatever is left till A is empty, and finally selection sort back to A. This required less than 700 instructions for 100 numbers, and about 6500 for 500. The details of her last refinement aren't perfectly clear to me, but it seems she introduced a cost check and, at each iteration of sorting back to A, pushed the cheapest option. This reduced her mean score for 500 numbers to "5300-5400 steps".
