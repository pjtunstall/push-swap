...
Note that, alhough the maximum is pushed to the top and the minimum to the bottom at each iteration while pushing to B, this will sort the numbers in ascending order on B, as Jamie did, which results in needless rotations while pushing back.
